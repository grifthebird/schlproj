...
int main() {
	...
	switch (sort) {
		case 0:
			...
			break;
		case 1:
			bubbleSortInPlace(codes, len, ZipCode::CompareType::LessCityState);
			break;
		case 2:
			bubbleSortInPlace(codes, len, ZipCode::CompareType::LessStateCity);
			break;
		case 3:
			bubbleSortInPlace(codes, len, ZipCode::CompareType::LessLatLonState);
			break;
		case 4:
			bubbleSortInPlace(codes, len, ZipCode::CompareType::LessLonLatState);
			break;
		default:
			return -1;
	}
